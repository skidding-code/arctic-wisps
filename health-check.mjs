...
async function main() {
  ...
  const header = [
    '# arctic public wisp endpoints',
    '# auto-generated by health-check.mjs — do not edit by hand',
    `# ${live.length}/${candidates.length} endpoints responded to a wisp handshake`,
    '',
  ]
